...
<div id="site-navigations" class="whitewaternav">
	<a href="#" id="closeNav" class="closeNav whitewaterclose"><span>x</span></a>

	
  <div class="nav__content">
  	<?php //get_template_part('parts/prenav'); ?>
  	<div class="nav-inner">
  		<nav class="navigationz animated whitewater">
  			<ul class="menu">
  	...
  	if($childenMenuItems) { ?>
  		...
  		<div id="childrenNavs" class="navigation-children-whitewater navigation__children">
  			<a href="#" id="closeNavChild" class="closeNav whitewaterclose"><span>x</span></a>
  			<div class="navchild-inner">
  				...
  				<?php $c=1; foreach ($childenMenuItems as $k=>$ch) { 
  					...
  					if($childrenData) { ?>
  					<div class="children-group-whitewater <?php echo $k ?>" data-parent="<?php echo $k ?>">
