...
// print_r($race_types);
// echo '</pre>';
$register_section_icon = get_sub_field("register_section_icon"); 
$box_section_title = get_sub_field("eventinfo_section_title"); 
$box_types = get_sub_field("event_info_box"); 
$register_section_title = get_sub_field("register_section_title"); 
$race_types = get_sub_field("race_types"); 
$registration_note = get_sub_field("registration_note");
